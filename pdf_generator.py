...
class VehicleDamageReportGenerator:
    ...
    def _setup_custom_styles(self):
        ...
        self.HEADER_BG = colors.HexColor('#FFF3D4')  # Light yellow - will be used for table headers
        ...
        # Section Header style - set consistent padding
        self.custom_styles['SectionHeader'] = ParagraphStyle(
            ...
            spaceAfter=4,
            leading=12,
            leftIndent=22,  # Changed from 25 to 22
            firstLineIndent=0,
